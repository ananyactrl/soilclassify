...
NAV_CARDS = [
    {
        ...
        "desc": "Run the agentic router on new satellite imagery with Grad-CAM.",
        "accent": "#38bdf8",
    },
    {
        ...
        "desc": "Classical ML, vanilla MobileNetV2, SE model, and router pipeline.",
        "accent": "#34d399",
    },
    {
        ...
        "desc": "Validation curves across easy, medium, and full-data phases.",
        "accent": "#a78bfa",
    },
    {
        "page": "Explainability",
        ...
        "desc": "See where the network attends and how channel excitation works.",
        "accent": "#f472b6",
    },
    {
        "page": "Clustering",
        "title": "Clusters",
        "subtitle": "Embedding structure",
        "desc": "K-Means and K-Medoids quality on learned representations.",
        "accent": "#fb923c",
    },
    {
        "page": "About",
        ...
        "desc": "Dataset, methods, architecture details, and references.",
        "accent": "#94a3b8",
    },
]
